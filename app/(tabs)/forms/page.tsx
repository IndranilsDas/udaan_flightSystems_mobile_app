  ...
  return (
    <SafeAreaView className='flex flex-col h-full justify-center items-center'>
      ...
      <View className='flex flex-col justify-center h-3/5 w-full gap-3'>
        <TextInput placeholder='select Project' className='border-b-2 w-full'/>
        <TextInput placeholder='Employee ID :' className='border-b-2 w-full'/>
        <TextInput placeholder='Drone ID :' className='border-b-2 w-full'/>
        <TextInput placeholder='Battery ID :' className='border-b-2 w-full'/>
        <TextInput placeholder='Start Voltage in Volts :' className='border-b-2 w-full'/>
      </View>
